...
setwd("/home/hulot/Documents/packages_R/mergeTrees/inst/article_reviews_2020_01_10/Simulations_performances/Simulations_performances_2020_02_03_3/")
...
source("util.R")
# 
setwd("/home/hulot/Documents/packages_R/mergeTrees/inst/article_reviews_2020_01_10/Simulations_performances/Simulations_performances_2020_02_03_3/k_svd_2_pc/")

# setwd("/travail/ahulot/Simulations_performances_2020_02_03_2/K_svd_2")
# setwd("/home/hulot/Documents/packages_R/mergeTrees/inst/article_reviews_2020_01_10/Simulations_performances/Simulations_performances_2_2020_01_27/Res_2020_02_03")
...
# sink("runs2.txt")
# mclapply(1:nrow(grid_param), FUN = function(i){
  ...
  MT_cases = res_plot[res_plot$Method=="MC",]
  
  # if(any(MT_cases$NID<=0.25)){
  ...
  # cat(paste0("n0=", n0, "_n1=", n1, "_ngroups=", n_grp, "_grp size=", grp_size,
  # "_ntab=",n_tables, "_ngrp_per_data=", n_grp_per_data, "_n_info=" , n_tab_info, ": oui_concluant\n"))
  # }else{
  # cat(paste0("n0=", n0, "_n1=", n1, "_ngroups=", n_grp, "_grp size=", grp_size,
  # "_ntab=",n_tables, "_ngrp_per_data=", n_grp_per_data, "_n_info=" , n_tab_info, ": non_concluant\n"))
  # }
}
# }, mc.cores = 2)
# sink()