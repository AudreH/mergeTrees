...
load("Tables_Etape_14_n_100_p_100.RData")
...
ggplot_mean$Method = revalue(ggplot_mean$Method, c("AC" = "AD"))
...
ggplot_mean$Method = revalue(ggplot_mean$Method, c("spMT" = "spMC"))
ggplot_mean = ggplot_mean[which(ggplot_mean$N>=100),]

breaks_var = c(100, 10^3, 10^4, 10^5, 10^6)
labels_var =  c(100, 1000,"1e+04", "1e+05", "1e+06")

breaks_ind = c(100, 10^3, 10^4, 10^5)
labels_ind = c(100, "1e+03","1e+04", "1e+05")

breaks_tab = c(100, 10^3, 10^4, 50000, 10^5)
labels_tab = c(100, 1000,"1e+04", 50000, "1e+05")

y_breaks = c(0.01, 0.1, 1, 10,100, 500, 2500)
y_labels = c("0.01", "0.1", "1", "10", "100", "500", "2500")
...
gg1 = ggplot(data = ggplot_mean[ggplot_mean$Comparison=="Individuals",], aes(x = N, y = Mean, colour = Method)) +
  ...
  facet_wrap_custom(Spectral~.,
                    ...
                    scale_overrides = list(
                      ...
                      scale_override(1, scale_y_continuous(trans = "log", breaks = y_breaks, labels = y_labels)),

                      scale_override(2, scale_x_continuous(trans = "log", breaks = breaks_ind, labels = labels_ind)),
                      scale_override(2, scale_y_continuous(trans = "log", breaks = y_breaks, labels = y_labels))
